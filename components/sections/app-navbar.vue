		...
		<div class="navbar-start">
			<div class="dropdown">
				<div tabindex="0" role="button" class="btn btn-ghost lg:hidden">
					<NuxtIcon name="ph:list" class="h-5 w-5" />
				</div>
				<ul tabindex="0" class="menu dropdown-content menu-sm z-[1] mt-3 w-52 rounded-box bg-base-100 p-2 shadow">
					...
					<!-- 		<li>
						...
						<ul class="p-2">
							<li>
								<nuxt-link to="/artiel">
									<NuxtIcon name="ph:game-controller-duotone" class="text-branding-artiel h-4 w-4" />
									Artiel
								</nuxt-link>
							</li>
							<li>
								<nuxt-link to="/iriss">
									<NuxtIcon name="ph:bookmarks-duotone" class="text-branding-iriss h-4 w-4" />
									Iriss
								</nuxt-link>
							</li>
							<li>
								<nuxt-link to="/nekokai">
									<NuxtIcon name="ph:cat-duotone" class="text-branding-nekokai h-4 w-4" />
									Nekokai
								</nuxt-link>
							</li>-
							<li>
								<nuxt-link to="/">
									<NuxtIcon name="ph:shield-duotone" class="h-4 w-4 text-branding-wolfstar" />
									WolfStar
								</nuxt-link>
							</li>
							<li>
								<nuxt-link to="/teryl">
									<NuxtIcon name="ph:books-duotone" class="text-branding-teryl h-4 w-4" />
									Teryl
								</nuxt-link>
							</li> -
					...
					<li>
						<nuxt-link :to="App.invite"><NuxtIcon name="ph:plus-circle-duotone" class="text-success" /> Invite App</nuxt-link>
					</li>
				</ul>
			</div>
		...
		<div class="navbar-center hidden lg:flex">
			<div class="group dropdown dropdown-hover">
				<div tabindex="0" role="button" class="btn btn-ghost m-1 items-center transition-all group-hover:text-white">
					Features
					<NuxtIcon name="ph:caret-down" class="rotate-0 transition-all group-hover:rotate-180" />
				</div>
			...
			<nuxt-link :to="App.invite" class="btn btn-ghost transition-colors hover:text-success">
				Invite App
				<NuxtIcon name="ph:plus-circle-duotone" />
			</nuxt-link>
		</div>
