<template>
	...
	<section class="join mt-16">
		<nuxt-link class="btn btn-wide join-item" :to="Invites.Teryl"><Icon name="ph:plus-circle-fill" class="w-5 h-5" /> Add App</nuxt-link>
...
.title {
	...
	line-height: 3.8rem;
	background: linear-gradient(to bottom in oklch, whitesmoke 40%, color-mix(in oklch, currentColor, oklch(var(--branding-teryl) / 1) 80%) 100%);
