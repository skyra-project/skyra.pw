	...
	return (
		<GeneralPage>
			<Container maxWidth="lg">
				...
				<Typography component="div">
					Skyra Project provides a chat bot for the <a href="https://discord.com/privacy">Discord</a> chat platform, (the "Bot"),
					a website that serves as a dashboard (the "Site") and various related services (collectively, the "Service(s)"). The
					Service is operated by Skyra Project (the "Company", "we" or "us") for users of the Service ("you" or the "user(s)").
					...
					<a href="https://discord.com/privacy">Discord</a> user data collected through the Services.
				</Typography>
				...
				<Typography component="div">
					...
					provide such information, such as when you use any of the Services. Information we collect may include but not be
					limited to cookies, usage data and, usernames, or other content you send via the chat feature when interacting with the
					Bot.
				</Typography>
				...
				<Typography component="div">
					<ul>
						<li>
							...
							Services, we receive and store certain information such as an IP address, device ID and your activities within
							the Services. We may store such information or such information may be included in the databases owned and
							maintained by affiliates, agents or service providers. The Services may use such information and pool it with
							other information to track, for example, the total number of visitors to our Site, the number of messages users
							have sent, as well as the sites which refer visitors to our Services.
						</li>
						<li>
							<span className={classes.boldText}>Cookies</span>: We employ cookies and similar technologies to keep track of
							your local computer's settings such as which account you have logged into on the Site. Cookies are pieces of
							data that sites and services can set on your browser or device that can be read on future visits. We may expand
							our use of cookies to save additional data as new features are added to the Service.
						</li>
						<li>
							...
							cookies by changing your browser settings. Further information about the procedure to follow in order to disable
							cookies can be found on your Internet browser provider's website via your help screen.
						</li>
					</ul>
				</Typography>
				...
				<Typography component="div">
					The Company is based in Spain and the Services are hosted from Germany. No matter where you are located you consent to
					processing and transferring of your information in and to Germany, Spain, and other countries. The laws of Germany,
					Spain, and other countries governing data collection and use may not be as comprehensive or protective as the laws of
				...
				<Typography component="div">
					<ul>
						<li>
							...
							processing (“opt-out”), without having to rely on consent or any other of the following legal bases. This,
				...
				<Typography component="div">
					<ul>
						...
						<li>
							<span className={classes.boldText}>Legal Requirements</span>: We may disclose your information if required to do
							so by law or in the good faith belief that such action is necessary to (i) comply with a legal obligation, (ii)
							protect and defend the rights or property of the Company or Related Companies, (iii) protect the personal safety
				...
				<Typography component="div">
					...
					information to us please contact us at <Email />. Note: In some countries, the age of digital consent is older than 13.
					If you are in those countries, you must be at least that age to use the Services. For example, for residents of the EEA,
					where processing of personal information is based on consent, Skyra Project will not knowingly engage in that processing
					for users under the age of consent established by applicable data protection law. If we learn that we are engaged in
					that processing with such users, we will halt such processing and will take reasonable measures to promptly remove
				...
				<Typography component="div">
					If you would like to submit a data access request, you can do so by sending an email to <Email />. Upon request we will
					start the process and provide you a link to access the personal data the Services has on you within 30 standard working
					days.
				</Typography>
				<Typography component="div">
					<ul>
				...
				<Typography component="div" classes={{ root: classes.spacedText }}>
					...
					categories of personal information: Discord User ID; internet or other network information (how you interact with the
					application); location information (because your IP address may indicate your general location); and other information
					that identifies or can be reasonably associated with you. For examples of the precise data points we collect and the
					sources of such collection, please see the <a href="#information-we-collect">“INFORMATION WE COLLECT”</a> section above.
					We collect personal information for the business and commercial purposes described in{' '}
				...
				<Typography component="div" classes={{ root: classes.spacedText }}>
					...
					<a href="#our-disclosure-of-your-information">“OUR DISCLOSURE OF YOUR INFORMATION”</a> section above. We disclose the
					categories of personal information mentioned above for business or commercial purposes.
				</Typography>
				<Typography component="div" classes={{ root: classes.spacedText }}>
				...
				<Typography component="div" classes={{ root: classes.spacedText }}>
					<span className={classes.boldText}>Exercising Your Consumer Rights</span>: If you are a California resident, you have
					the right to request (1) more information about the categories and specific pieces of personal information we have
					collected and disclosed for a business purpose in the last 12 months, (2) deletion of your personal information, and (3)
					to opt out of sales of your personal information, if applicable. Details on how to make these requests are in the{' '}
					<a href="#your-data-rights-and-choices">“YOUR DATA RIGHTS AND CHOICES”</a> section above. We will not discriminate
				...
				<Typography component="div">
					...
					the Services. You may contact us as follows: <Email />.
				</Typography>
				{[0, 1, 2].map(idx => (
					<LineSpacer key={idx} />
				))}
