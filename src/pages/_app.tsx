...
const App: NextPage<AppProps> = ({ Component, pageProps }) => {
	...
	const [pack, setPack] = useState<DashboardPack>(loadState<DashboardPack>(LocalStorageKeys.DiscordPack) ?? { user: null });

	const toggleAuthenticated = () => {
		setAuthenticated(!authenticated);
	};

	const updatePack = (newPack: DashboardPack) => {
		setPack(newPack);
	};
	...
	return (
		<>
			...
			<Provider session={pageProps.session}>
				<GlobalStateContextProvider value={{ authenticated, pack, toggleAuthenticated, updatePack }}>
