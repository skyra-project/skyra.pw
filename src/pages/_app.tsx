...
const App: NextPage<AppProps> = ({ Component, pageProps }) => {
	useEffect(() => {
		...
		if (process.env.NODE_ENV === 'production') {
			console.log(
				'%cHold Up!',
				`color: ${theme.primary.main}; font-size: 72px; font-weight: bold; -webkit-text-stroke: 2px ${theme.common.black}`
			);
			console.log(
				[
	...
	return (
		<>
			<Head>
				...
				<link rel="mask-icon" href="/icons/safari-pinned-tab.svg" color={theme.primary.main} />
			...
			<AuthenticatedProvider>
				<DiscordPackProvider>
					<CookieConsentProvider>
						<Component {...pageProps} />
						<NextNprogress color={colors.blue['900']} startPosition={0.3} stopDelayMs={200} height={3} />
					</CookieConsentProvider>
				</DiscordPackProvider>
			</AuthenticatedProvider>
		</>
